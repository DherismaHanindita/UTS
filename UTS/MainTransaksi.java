...
public class MainTransaksi {
    ...
    static void rekeningB(){
        Rekening r1 = new Rekening("161006170573","bin Abdul Salam","Aruffin ","14582643263","ligula.Nullam@tacitisociosqu.edu");
